...
//    private LoadBalancerClient client;
    ...
    public void closeOrder() {
        ...
        LambdaQueryWrapper<OrderStatus> wrapper = new LambdaQueryWrapper<>();
        wrapper.eq(OrderStatus::getOrderStatus, OrderStatus.OrderStatusEnum.WAIT_PAY.type);
